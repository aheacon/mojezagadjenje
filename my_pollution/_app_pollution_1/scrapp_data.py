...
def scrap_aqi():
  ...
  for j in range(len(t)):
    ...
    temp1=x[i].findAll('td')[temp+1].text
    lokacije[lokacija].append({
      ...
      "o3":x[i].findAll('td')[temp+6].text,
      "pm10":x[i].findAll('td')[temp+7].text,
      "pm2.5":""
    })
  # Vranduk is special
  lokacija= x[13].findAll('td')[0].text #vranduk
  #print(x[13].findAll('td'))
  lokacije[lokacija]=[]
  ...
  lokacije[lokacija].append({
    "so2":x[13].findAll('td')[1].text,
    "h2s":"",
    "no2":"",
    "nox":"",
    "no":"",
    "co":"",
    "o3":x[13].findAll('td')[3].text,
    "pm10":x[13].findAll('td')[4].text,
    "pm25":x[13].findAll('td')[5].text
  })
  return lokacije
